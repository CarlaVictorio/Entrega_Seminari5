...
router.post('/', (0, ValidateSchema_1.ValidateSchema)(ValidateSchema_1.Schemas.book.create), Book_1.default.createBook); //dins dels controller tenim els models, li passem HTTP
...
router.get('/:bookId/author', Book_1.default.readAllB);
